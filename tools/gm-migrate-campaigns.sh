#!/bin/bash
# gm-migrate-campaigns.sh - Migrate legacy world-state to multi-campaign structure
...
if [ "$HAS_DATA" = false ]; then
    ...
    echo "Use 'gm-campaign.sh create <name>' to create a new campaign."
    exit 0
fi
...
echo ""
echo "Next steps:"
echo "  1. Verify the migration: gm-campaign.sh info"
echo "  2. Test the tools: gm-overview.sh"
